...
public class MainUsingDbQuery {
	...
	private static OrderItemDao oiDao;
	...
	public static void main(String[] args) throws IOException {
		...
		oiDao = ctx.getBean(OrderItemDao.class);
	...
	public static void processAddOrders(String[] arg) { // 주문추가
		oiDao.addOrderItem(new OrderItem(0, Long.parseLong(arg[1]), Long.parseLong(arg[2]), Integer.parseInt(arg[3]), null));	// 날짜는 mysql에서 넣으므로 null
